...
use App\Repositories\AnnouncementTranslationRepoistory;

class AnnouncementTranslationService extends BaseService
{
    public function __construct(AnnouncementTranslationRepoistory $repo)
    {
